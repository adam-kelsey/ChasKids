class ChangeIntegerLimitTo15 < ActiveRecord::Migration
  def change
    change_column :venues, :facebook_id, :integer, :limit => nil
    ...
    change_column :venues, :birthday_party_venue, :boolean
